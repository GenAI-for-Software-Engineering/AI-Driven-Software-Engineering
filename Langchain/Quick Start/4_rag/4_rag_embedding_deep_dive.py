...
# Function to create and persist vector store using modern persistent clients
...
# Updated to the newer, highly optimized small embedding model
...
# Function to query a vector store via modern persistent clients
